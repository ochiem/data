...
//                console.warn(`⛔ Tidak ada fallback tersedia untuk ${dexName}`);
    ...
    `.trim();
        ...
        if (pnlNetto > 0) {
            ...
            const existingSignal = listEl?.querySelector(`[data-key="${signalKey}"]`);

            if (!this.pnlSignals[dexKey][signalKey] && !existingSignal) {
                ...
                if (listEl) {
                    ...
                    div.setAttribute("data-key", signalKey);
                    div.innerHTML = signalText;
    ...
    initPNLSignalStructure() {
        ...
        for (const dex of DexList) {
            ...
            const line = $(`
                <div class="d-flex border-bottom align-items-center" style="border-color: #ddd; padding: 4px 0;">
                    <div class="${textColor} fw-semibold fs-7 text-end pe-2 flex-shrink-0"
